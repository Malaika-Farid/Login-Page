  ...
  return (
    ...
    <div className="border-2  bg-slate-900 rounded-lg border-spacing-20 p-8">
        ...
        <div>
            ...
            <input type="text" name="" id="" required placeholder="name@company.com"
                className="border-2  block rounded-lg w-full p-2 text-black" />
        </div>
        <div>
            <label htmlFor="Password" className="text-left block py-2">
                PASSWORD
            </label>
            <input type="password" name="" id="" required placeholder="••••••••"
                className="border-2 block rounded-lg w-full p-2 text-black" />
        </div>
        <div>
